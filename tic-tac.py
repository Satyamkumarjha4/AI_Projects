...
if 'current_player' not in st.session_state:
    st.session_state.current_player = 'X'  # Player 1 is 'X', Player 2 is 'O'
...
def ai_blocking_move():
    # AI strategy to block the player or make a winning move
    for coin in ['O', 'X']:
        for i in range(3):
...
def main():
    ...
    st.session_state.mode = st.radio("Select Mode:", ('Single Player', 'Two Player'))
